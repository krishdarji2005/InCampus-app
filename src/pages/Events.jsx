...
const events = [
  ...
  const Cell = ({ columnIndex, rowIndex, style }) => {
    ...
    return (
      <div style={{ ...style, left: style.left + GUTTER/2, top: style.top + GUTTER/2 }}>
        ...
        <div className={styles.eventsCardsContent}>
          {useVirtual ? (
            <Grid
              ...
              width={typeof window !== 'undefined' ? Math.min(columnCount * (CARD_WIDTH + GUTTER), window.innerWidth - 32) : 1200}
              height={Math.min(600, rowCount * (CARD_HEIGHT + GUTTER))}
